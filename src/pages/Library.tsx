...
import { Play, Download, Trash2, Search, Filter, Clock, Eye, MoreVertical } from "lucide-react";
  ...
  const videos: Video[] = [
    {
      ...
      description: "Complete guide to replacing a broken door on Rational SelfCookingCenter 101",
    ...
    },
    {
      ...
      description: "Routine maintenance procedure for cleaning heating elements",
      thumbnail: "/api/placeholder/400/225",
      duration: "3:15",
      model: "Rational SCC 101",
      taskType: "Cleaning",
    ...
    },
    {
      ...
      description: "Step-by-step guide for replacing the control panel display unit",
      thumbnail: "/api/placeholder/400/225",
      duration: "6:48",
          ...
          <Card key={video.id} className="overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-2">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <Badge variant="outline">{video.taskType}</Badge>
              </div>
